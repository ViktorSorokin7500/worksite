...
const pages = [
...

	{
		...
		desc: "Оцінка нерухомості допомагає визначити ринкову вартість перед продажем, покупкою або для отримання іпотеки. Це також важливо юридичних процедур, таких як спадщина або розподіл майна, а також для судових справ",
	},
];
